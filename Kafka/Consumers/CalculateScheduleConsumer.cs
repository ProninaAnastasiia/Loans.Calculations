...
public class CalculateScheduleConsumer : KafkaBackgroundConsumer
{
    public CalculateScheduleConsumer(
        ...
        : base(config, serviceProvider, logger,
            ...
            groupId: "calculations-service-group",
    ...
    private async Task ProcessCalculateScheduleRequestedAsync(CalculateRepaymentScheduleEvent @event,
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex,
                "Ошибка при обработке события CalculateRepaymentScheduleEvent: {EventId}, {OperationId}",
