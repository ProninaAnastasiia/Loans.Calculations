...
public class ScheduleCalculationService : IScheduleCalculationService
{
    ...
    public async Task<Guid> CalculateRepaymentAsync(Guid contractId, decimal loanAmount, int loanTermMonths,
        decimal interestRate, string paymentType, CancellationToken cancellationToken)
    {
